...
import br.com.meuprojeto.forum.controller.dto.DetalhesDoTopicoDto;
import br.com.meuprojeto.forum.controller.dto.TopicoDto;
import br.com.meuprojeto.forum.controller.form.AtualizacaoTopicoForm;
...
public class TopicosController {
	...
	public ResponseEntity<DetalhesDoTopicoDto> detalhar(@PathVariable Long id) {
		...
		if(optional.isPresent()) {
			return ResponseEntity.ok(new DetalhesDoTopicoDto(optional.get())); // get() pega o real tópico dentro do optional
		}
